...
Constants->>
*/
defined('THEME_NAME') or define('THEME_NAME', 'canoetrip');
...
if( !function_exists('cbv_theme_setup') ){
    ...
    function cbv_theme_setup(){
      ...
      load_theme_textdomain( 'canoetrip', get_template_directory() . '/languages' );
        ...
        register_nav_menus( array(
            'cbv_main_menu' => __( 'Hoofdmenu', 'canoetrip' ),
            'cbv_mobile_menu' => __( 'Mobielmenu', 'canoetrip' ),
            'cbv_fta_menu' => __( 'Footer Menu', 'canoetrip' ),
            'cbv_copyright_menu' => __( 'Copyright Menu', 'canoetrip' ),
        ) );
...
if( function_exists('acf_add_options_page') ) { 
    ...
    acf_add_options_page(array(
        'page_title'    => __('Options', 'canoetrip'),
        'menu_title'    => __('Options', 'canoetrip'),
